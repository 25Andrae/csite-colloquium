...
export function Programme() {
  const schedule = [
    ...
    },
    {
      ...
      title: "Message of Support from DOST IX",
      icon: Presentation,
      description: "Interactive Q&A session with the plenary speaker.",
    },
    {
      time: "11:25 AM - 11:30 AM",
      title: "Presentation of Certification to the Keynote Speaker & DOST IX",
      icon: Award,
      description: "Awarding of certification to the speaker and DOST IX.",
    },
    {
